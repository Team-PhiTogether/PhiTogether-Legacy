...
export const frameTimer = { //计算fps
	...
	addTick(fr = 10) {
		if (++this.tick >= fr) {
			this.tick = 0;
			this.fpsPrecise = 1e3 * fr / (-this.time + (this.time = performance.now()));
			this.fps = Math.round(this.fpsPrecise)
		}
		return this.fps;
	},
	get fpsStr() {
...
export const urls = {
	zip: ['/static/utils/js/zip.min.js'],
	jszip: ['/static/utils/js/jszip.js'],
	browser: ['/static/utils/js/Browser.js'],
	bitmap: ['/static/utils/js/createImageBitmap.js'],
	blur: ['/static/utils/js/stackblur-canvas.js'],
	md5: ['/static/utils/js/md5-js.js'],
}
